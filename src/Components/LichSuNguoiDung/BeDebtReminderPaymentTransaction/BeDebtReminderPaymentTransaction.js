...
import './BeDebtReminderPaymentTransaction.css';

const BeDebtReminderPaymentTransaction = props => {
    ...
    const columns = [
        ...
        {
            title: 'Nhận từ',
            dataIndex: 'receiverFrom',
            key: 'receiverFrom',
            ...getColumnSearchProps('receiverFrom'),
        },
        {
            title: 'Số tiền',
            dataIndex: 'amount',
    ...
    return (
        <Table
            ...
            expandable={{
                expandedRowRender: record => (
                    <Descriptions title="Chi tiết">
                        ...
                        <Descriptions.Item label="Nhận từ">{record.receiverFrom}</Descriptions.Item>
            ...
            pagination={{
                ...
                total: beDebtReminderPaymentTransactionArray.length,
                pageSize,
                onShowSizeChange,
                current: currentPage,
...
export default BeDebtReminderPaymentTransaction;